...
var seedComponents = []Component{
	// ── engine: 사원이 사용하는 업무 서비스 (8) ──
	{ID: "stalwart", Name: "HELIOS Mail", Description: "메일 서버 (Stalwart)", Category: "engine", SortOrder: 1,
		ContainerName: "polyon-mail", Engine: "stalwart", Host: "polyon-mail", Port: 8080,
		HealthEndpoint: "/healthz", HealthMethod: "GET", Icon: "email", Accent: "#0f62fe",
		DependsOn: j(`["postgresql","polyon-dc","elasticsearch"]`), Status: "active"},
	{ID: "mattermost", Name: "HELIOS Chat", Description: "팀 메신저 (Mattermost)", Category: "engine", SortOrder: 2,
		...
		DependsOn: j(`["postgresql","polyon-auth"]`), Status: "active"},
	{ID: "nextcloud", Name: "HELIOS Drive", Description: "문서 관리 (Nextcloud)", Category: "engine", SortOrder: 3,
		...
		DependsOn: j(`["postgresql","redis","polyon-auth"]`), Status: "active"},
	{ID: "onlyoffice", Name: "HELIOS Office", Description: "문서 편집 (OnlyOffice Docs)", Category: "engine", SortOrder: 4,
	...
	{ID: "affine", Name: "HELIOS Wiki", Description: "지식 관리 (AFFiNE)", Category: "engine", SortOrder: 5,
	...
	{ID: "odoo", Name: "HELIOS ERP", Description: "전사 자원관리 (Odoo)", Category: "engine", SortOrder: 6,
		ContainerName: "polyon-odoo", Engine: "odoo", Host: "polyon-odoo", Port: 8069,
		HealthEndpoint: "/web/health", HealthMethod: "GET", Icon: "dataBase", Accent: "#714B67",
		DependsOn: j(`["postgresql"]`), Status: "active"},
	{ID: "gitea", Name: "HELIOS Git", Description: "Git 저장소 (Gitea)", Category: "engine", SortOrder: 7,
		ContainerName: "polyon-gitea", Engine: "gitea", Host: "polyon-gitea", Port: 3000,
		HealthEndpoint: "/api/healthz", HealthMethod: "GET", Icon: "code", Accent: "#609926",
		DependsOn: j(`["postgresql"]`), Status: "active"},
	{ID: "runner", Name: "HELIOS CI/CD", Description: "CI/CD 실행기 (Gitea Actions Runner)", Category: "engine", SortOrder: 8,
		...
		DependsOn: j(`["gitea"]`), Status: "active"},
	{ID: "strapi", Name: "HELIOS CMS", Description: "웹사이트 빌더 · CMS (Strapi)", Category: "engine", SortOrder: 8,
	...
	// ── ai: AI 에이전트 및 지능 레이어 (3) ──
	{ID: "litellm", Name: "HELIOS AI", Description: "AI Gateway — LLM 라우팅 (LiteLLM)", Category: "ai", SortOrder: 1,
		ContainerName: "polyon-ai", Engine: "litellm", Host: "polyon-ai", Port: 4000,
		HealthEndpoint: "/health", HealthMethod: "GET", Icon: "dataBase", Accent: "#6929c4",
		DependsOn: j(`["postgresql"]`), Status: "active"},
	{ID: "openclaw", Name: "HELIOS Agent", Description: "AI Agent Runtime (OpenClaw)", Category: "ai", SortOrder: 2,
		...
		DependsOn: j(`["litellm","mem0","polyon-auth"]`), Status: "deployed"},
	{ID: "mem0", Name: "HELIOS Memory", Description: "AI 기억 레이어 (Mem0)", Category: "ai", SortOrder: 3,
		...
		DependsOn: j(`["postgresql"]`), Status: "deployed"},

	// ── process: 비즈니스 프로세스 및 업무 자동화 (2) ──
	{ID: "operaton", Name: "HELIOS BPMN", Description: "비즈니스 프로세스 (Operaton)", Category: "process", SortOrder: 1,
		...
		DependsOn: j(`["postgresql"]`), Status: "active"},
	{ID: "n8n", Name: "HELIOS Auto", Description: "워크플로우 자동화 (n8n)", Category: "process", SortOrder: 2,
	...
	// ── core: PolyON 플랫폼 자체 구성 요소 (5) ──
	{ID: "polyon-console", Name: "PolyON UI", Description: "Admin Console", Category: "core", SortOrder: 1,
	...
	{ID: "polyon-core", Name: "HELIOS Core", Description: "API Gateway (Go)", Category: "core", SortOrder: 2,
	...
	{ID: "polyon-dc", Name: "HELIOS AD DC", Description: "Active Directory", Category: "core", SortOrder: 3,
	...
	{ID: "keycloak", Name: "HELIOS Auth", Description: "SSO / Authentication (Keycloak)", Category: "core", SortOrder: 4,
		...
		DependsOn: j(`["postgresql"]`), Status: "active"},
	{ID: "opa", Name: "HELIOS Policy", Description: "인가 · 정책 엔진 (OPA)", Category: "core", SortOrder: 5,
	...
	// ── infra: 데이터베이스, 스토리지, 네트워크 (5) ──
	{ID: "postgresql", Name: "PostgreSQL", Description: "Database", Category: "infra", SortOrder: 1,
		...
		DependsOn: j(`[]`), Status: "active"},
	{ID: "redis", Name: "Redis", Description: "Cache", Category: "infra", SortOrder: 2,
		...
		DependsOn: j(`[]`), Status: "active"},
	{ID: "elasticsearch", Name: "Elasticsearch", Description: "Search", Category: "infra", SortOrder: 3,
		ContainerName: "polyon-search", Engine: "elasticsearch", Host: "polyon-search", Port: 9200,
		HealthEndpoint: "/_cluster/health", HealthMethod: "GET", Icon: "search", Accent: "#fed10a",
		DependsOn: j(`[]`), Status: "active"},
	{ID: "rustfs", Name: "RustFS", Description: "Object Storage", Category: "infra", SortOrder: 4,
		ContainerName: "polyon-rustfs", Engine: "rustfs", Host: "polyon-rustfs", Port: 9000,
		HealthEndpoint: "/minio/health/live", HealthMethod: "GET", Icon: "dataBase", Accent: "#dea584",
		DependsOn: j(`[]`), Status: "active"},
	{ID: "traefik", Name: "Traefik", Description: "Reverse Proxy", Category: "infra", SortOrder: 5,
		ContainerName: "polyon-proxy", Engine: "traefik", Host: "polyon-proxy", Port: 8080,
		HealthEndpoint: "/ping", HealthMethod: "GET", Icon: "network4", Accent: "#24a1c1",
		DependsOn: j(`[]`), Status: "active"},

	// ── monitoring: 관측 및 대시보드 (2) ──
	...
	{ID: "grafana", Name: "Grafana", Description: "Dashboard", Category: "monitoring", SortOrder: 2,
		...
		DependsOn: j(`["prometheus"]`), Status: "active"},
}
